/* =========================================================
   ...
   ✏️  PASTE YOUR GEMINI API KEY BELOW (between the quotes).
       Get a free key at: https://aistudio.google.com/app/apikey
       Once set, the app NEVER asks for a key again.

   Leave it empty ('') to use the built-in knowledge base instead.
   ========================================================= */
'use strict';

// ── 🔑 YOUR API KEY — edit this one line ─────────────────
const HARDCODED_KEY = 'AIzaSyBq9foXO_ifgRF1rDHRXHO6eHiM3zhRnPk';
